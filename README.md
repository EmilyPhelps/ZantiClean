...
Obviously its not ideal to change what you want to look at after the
experiment but the XY coordinates measure of Zantiks allows for this.
...
finer scale inferences within exisitng zones, or changing zone size in
open field trials.
...
Now we need to create a dataframe delimiting the zoens we want. Each
